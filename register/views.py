...
from hotel.permission import isFront_DeskorReadOnly, isManagementorReadOnly, isGuestorReadOnly, isAdminorReadOnly
...
class StaffViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields=('user','contact_info',) 
    search_fields=('availability',)
    permission_classes=[IsAuthenticated, isFront_DeskorReadOnly, isManagementorReadOnly, isGuestorReadOnly, isAdminorReadOnly]
